...
var Client = {
	...
	onPeering : function(receivedPeeringPacket, callingPeer) {
		...
		if((client.pool.usedConnections < client.pool.size) && !client.pool.exists(receivedPeeringPacket.body.originator)) {
			...
			delete receivedPeeringPacket.body.candidates;
			delete receivedPeeringPacket.body.originator;
			delete receivedPeeringPacket.body.port;
			receivedPeeringPacket.body = receivedPeeringPacket.body.offer;
