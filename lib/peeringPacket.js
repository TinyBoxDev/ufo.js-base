var peeringPacket = function(from) {
	...
	this.CANDIDATE_11 = null;
	this.CANDIDATE_12 = null;
	this.CANDIDATE_21 = null;
	this.CANDIDATE_22 = null;
...
peeringPacket.prototype.fromOffer = function(offer) {
	...
	this.CANDIDATE_11 = separatedOffer[9].split('a=candidate:')[1];
	this.CANDIDATE_12 = separatedOffer[10].split('a=candidate:')[1];
	this.CANDIDATE_21 = separatedOffer[11].split('a=candidate:')[1];
	this.CANDIDATE_22 = separatedOffer[12].split('a=candidate:')[1];
...
peeringPacket.prototype.toOffer = function() {
	...
	'a=candidate:' + this.CANDIDATE_11 + '\r\n' +
	'a=candidate:' + this.CANDIDATE_12 + '\r\n' +
	'a=candidate:' + this.CANDIDATE_21 + '\r\n' +
	'a=candidate:' + this.CANDIDATE_22 + '\r\n' +
...
peeringPacket.prototype.fill = function(packet) {
	...
	this.CANDIDATE_11 = packet.CANDIDATE_11;
	this.CANDIDATE_12 = packet.CANDIDATE_12;
	this.CANDIDATE_21 = packet.CANDIDATE_21;
	this.CANDIDATE_22 = packet.CANDIDATE_22;
