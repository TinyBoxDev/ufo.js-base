var peeringReplyPacket = function(from) {
	...
	this.CANDIDATE_1 = null;
	this.CANDIDATE_2 = null;
...
peeringReplyPacket.prototype.fromAnswer = function(offer) {
	...
	this.CANDIDATE_1 = separatedOffer[9].split('a=candidate:')[1];
	this.CANDIDATE_2 = separatedOffer[10].split('a=candidate:')[1];
...
peeringReplyPacket.prototype.toAnswer = function() {
	...
	'a=candidate:' + this.CANDIDATE_1 + '\r\n' +
	'a=candidate:' + this.CANDIDATE_2 + '\r\n' +
...
peeringReplyPacket.prototype.fill = function(packet) {
	...
	this.CANDIDATE_1 = packet.CANDIDATE_1;
	this.CANDIDATE_2 = packet.CANDIDATE_2;
