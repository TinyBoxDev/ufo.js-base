...
Peer.prototype.createSocketForPeer = function(peeringPacket, callingPeer, onConnected) {
	...
	var spdOffer = peeringPacket.body.offer;
        sdpOffer += '\r\n';
	this.peerConnection.setRemoteDescription(new RTCSessionDescription({ 'type' : 'offer', 'sdp' : sdpOffer }), onRemoteDescriptionAdded, generalFailureCallback);
