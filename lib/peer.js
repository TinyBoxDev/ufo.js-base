...
Peer.prototype.lookForAPeer = function(onPeerFound) {
	...
	this.peerConnection.onopen = this.peerConnection.onconnection = function() {
		// 3. create a temporany data channel
		var localDataChannel = self.peerConnection.createDataChannel('datachannel', { reliable : false, outOfOrderAllowed : true, maxRetransmitNum : 0 });
