...
var Peer = function(bootstrapServerAddress, onBootstrapPerformed) {
	...
	this.channel.on('setId', function(setIdPacket) {
		...
		self.findFirstAPeer(function(socket, retrievedPeerId) {
...
Peer.prototype.findSomeoneElse = function(basePeer, onPeerFound) {
	var self = this;
...
Peer.prototype.findFirstPeer = function(onPeerFound) {
	var self = this;
	var retrievedPeerId = null;
