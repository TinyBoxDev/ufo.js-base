...
var mozCreateSocketForPeer = function(peeringPkt, onConnected) {
  ...
  this.peerConnection.setRemoteDescription(peeringPkt.body.completeSDP, onOfferAdded, generalFailureCallback);

  // 2. Create a new answer
  var onOfferAdded = function() {
    this.peerConnection.createAnswer(onAnswerCreated, generalFailureCallback);
  }
  ...
  var onAnswerCreated = function(answer) {
    ...
    this.peerConnection.setLocalDescription(answer, startConnection, generalFailureCallback);
  }

  // 4. Starting connection procedure
  var startConnection = function() {
    this.peerConnection.connectDataConnection(localPort, remotePort);
  }
